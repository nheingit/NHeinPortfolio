<div class='h-auto bg-true-blue'>
  <div class="container relative py-5 mx-auto">
    <img loading='lazy' class='absolute left-0 bottom-14 h-4/5'src="downArrow.svg" alt="arrow pointing from avatar down to button">
    <img loading='lazy' class='relative w-56 ml-20 lg:w-80' src='gardenMe.png' alt='Noah with garden in background'>
    <div class="ml-20 mr-4 bg-gray-100 rounded-3xl">
      ...
      <p class='px-4 py-2'>You have a proudct or service that delivers RESULTS to your clients</p>
